...
import 'create_new_prices_widget.dart' show CreateNewPricesWidget;
import 'package:flutter/material.dart';

class CreateNewPricesModel extends FlutterFlowModel<CreateNewPricesWidget> {
  ...
  // Stores action output result for [Backend Call - Insert Row] action in changePriceButton widget.
  AreaPricesRow? updatePrices;
