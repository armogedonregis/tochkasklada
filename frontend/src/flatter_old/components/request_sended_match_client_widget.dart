...
import 'request_sended_match_client_model.dart';
export 'request_sended_match_client_model.dart';

class RequestSendedMatchClientWidget extends StatefulWidget {
  const RequestSendedMatchClientWidget({
    super.key,
  ...
  @override
  State<RequestSendedMatchClientWidget> createState() =>
      _RequestSendedMatchClientWidgetState();
}

class _RequestSendedMatchClientWidgetState
    extends State<RequestSendedMatchClientWidget> {
  late RequestSendedMatchClientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestSendedMatchClientModel());
                ...
                children: [
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 12.0, 0.0),
                          child: Text(
                            '${widget.clientname}! Ячейка найдена!',
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      'sb7vjzpp' /* AI-сторож Тихон нашел подходящ... */,
                    ),
                  ...
                  Padding(
                    ...
                    child: Wrap(
                      ...
                      children: [
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.userReservedCellCopy =
                                ...
                                data: {
                                  'notes':
                                      'Ячейка найдена. Просит связаться. Есть в клиентской базе',
                                },
                                matchingRows: (rows) => rows
                                    .eqOrNull(
                                      'request_id',
                        ...
                        if (widget.clientname != widget.username)
                          Align(
                            alignment: AlignmentDirectional(0.0, 0.0),
                            child: FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed(
                                  ChangeMailWidget.routeName,
                                  queryParameters: {
