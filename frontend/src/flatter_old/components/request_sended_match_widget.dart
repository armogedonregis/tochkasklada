...
import 'request_sended_match_model.dart';
export 'request_sended_match_model.dart';

class RequestSendedMatchWidget extends StatefulWidget {
  const RequestSendedMatchWidget({
    super.key,
  ...
  @override
  State<RequestSendedMatchWidget> createState() =>
      _RequestSendedMatchWidgetState();
}

class _RequestSendedMatchWidgetState extends State<RequestSendedMatchWidget> {
  late RequestSendedMatchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestSendedMatchModel());
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      'kdrm7z2g' /* AI-сторож Тихон нашел подходящ... */,
                    ),
                  ...
                  if (FFAppState().viewAsFranchisor)
                    Text(
                      ' тест режим - видно только франчайзеру: cell${widget.hasCell}username${widget.username}${widget.email}${widget.phone}req ${widget.requestID}',
                      style: FlutterFlowTheme.of(context).bodyLarge.override(
                            fontFamily: 'Montserrat',
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.createdClientID =
                                ...
                                'client_id':
                                    '${widget.email}-${valueOrDefault<String>(
                                  dateTimeFormat(
                                    "dd-MM-yy HH:mi",
                                    getCurrentTimestamp,
