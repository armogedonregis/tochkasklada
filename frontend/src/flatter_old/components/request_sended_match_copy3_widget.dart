...
import 'request_sended_match_copy3_model.dart';
export 'request_sended_match_copy3_model.dart';

class RequestSendedMatchCopy3Widget extends StatefulWidget {
  const RequestSendedMatchCopy3Widget({
    super.key,
  ...
  @override
  State<RequestSendedMatchCopy3Widget> createState() =>
      _RequestSendedMatchCopy3WidgetState();
}

class _RequestSendedMatchCopy3WidgetState
    extends State<RequestSendedMatchCopy3Widget> {
  late RequestSendedMatchCopy3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestSendedMatchCopy3Model());
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      'at8ish72' /* AI-сторож Тихон нашел подходящ... */,
                    ),
