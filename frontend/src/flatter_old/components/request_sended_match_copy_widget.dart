...
import 'request_sended_match_copy_model.dart';
export 'request_sended_match_copy_model.dart';

class RequestSendedMatchCopyWidget extends StatefulWidget {
  const RequestSendedMatchCopyWidget({
    super.key,
  ...
  @override
  State<RequestSendedMatchCopyWidget> createState() =>
      _RequestSendedMatchCopyWidgetState();
}

class _RequestSendedMatchCopyWidgetState
    extends State<RequestSendedMatchCopyWidget> {
  late RequestSendedMatchCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestSendedMatchCopyModel());
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      'y6mrmy0q' /* AI-сторож Тихон нашел подходящ... */,
                    ),
