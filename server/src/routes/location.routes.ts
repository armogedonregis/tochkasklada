...
router.post('/', json_checker, authMiddleware, locationControllers.create_location)
router.put('/:id', json_checker, authMiddleware, locationControllers.update_location)
router.delete('/:id', authMiddleware, locationControllers.delete_location)
